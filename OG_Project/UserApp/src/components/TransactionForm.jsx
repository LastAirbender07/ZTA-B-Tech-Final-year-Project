...
import { addTransaction } from "../reducers/userSlice"; // Example import for Redux action

const TransactionForm = () => {
  const dispatch = useDispatch();
  const { loading } = useSelector((state) => state.user); // Assuming the loading state is in the transactions slice of the store
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Dispatch the add transaction action
